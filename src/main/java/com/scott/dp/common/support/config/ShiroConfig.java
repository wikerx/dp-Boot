...
import com.scott.dp.common.support.shiro.listener.UserSessionListener;
import com.scott.dp.common.support.shiro.session.UserSessionDAO;
import com.scott.dp.common.support.shiro.session.UserSessionFactory;
import com.scott.dp.modules.sys.shiro.UserFilter;
import com.scott.dp.modules.sys.shiro.UserPermFilter;
import com.scott.dp.modules.sys.shiro.UserRealm;
import com.scott.dp.common.support.properties.GlobalProperties;
import com.scott.dp.modules.sys.shiro.ShiroPermsFilterFactoryBean;
...
public class ShiroConfig {
    ...
    /**
     * shiro过滤器
     * /rest/**，请求采用token验证（RestApiInterceptor）

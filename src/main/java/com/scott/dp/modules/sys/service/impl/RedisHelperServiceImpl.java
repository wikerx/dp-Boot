...
import com.scott.dp.modules.sys.service.RedisHelperService;
...
/**
 * @CLASSNAME :RedisHelperServiceImpl
 * @Description :DOTO
 * @Author :Mr.薛
 * @Data :2019/5/23  16:03
 * @Version :V1.0
 * @Status : 编写
 **/
@Service("RedisHelper")
public class RedisHelperServiceImpl<HK, T> implements RedisHelperService<HK, T> {
    ...
    @Autowired
    public RedisHelperServiceImpl(RedisTemplate<String, T> redisTemplate) {

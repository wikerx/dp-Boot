...
public class SysUserServiceImpl implements SysUserService {
	 ...
	 * @return
	 */
	public List<SysUserEntity> select(Long deptId){
		return sysUserMapper.select(deptId);
	}
	 ...
	 * @return
	 */
	public SysUserEntity getByUserIdOne(Long userId){
		return sysUserMapper.getByUserIdOne(userId);
	}
}

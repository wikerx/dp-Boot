...
-- ----------------------------
INSERT INTO `qrtz_cron_triggers` VALUES ('quartzScheduler', 'TASK_1', 'DEFAULT', '0/500 * * * * ? ', 'Asia/Shanghai');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('quartzScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', null, '1546589940000', '-1', '5', 'PAUSED', 'CRON', '1546589920000', '0', null, '2', );
...
-- ----------------------------
INSERT INTO `quartz_job` VALUES ('1', 'testTask', 'test', null, '0/500 * * * * ? ', '0', '5秒真理测试', '2018-12-29 10:51:36', '2019-01-04 15:03:13');
INSERT INTO `quartz_job` VALUES ('2', 'testTask', 'scaningFile', 'E:\\work\\idea\\dp-BOOT\\doc', '0/1000 * * * * ? ', '0', '文件扫描枪', '2018-12-29 10:53:17', '2019-01-04 15:03:04');
...
CREATE TABLE `sys_department` (
  ...
  `create_id` bigint(20) default NULL COMMENT '创建人/修改id',
...
CREATE TABLE `sys_file` (
  ...
  `file_add` varchar(500) default NULL COMMENT '文件位置',
  `file_up_id` bigint(20) default NULL COMMENT '上传者编号',
  `remark` varchar(200) default NULL COMMENT '上传说明',
  `up_time` datetime default NULL COMMENT '上传时间',
  `file_type` int(2) default NULL COMMENT '文件类型',
  `file_new_name` varchar(200) default NULL COMMENT '新文件名称',
  PRIMARY KEY  (`file_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `sys_org` (
  ...
  `gmt_modified` datetime default NULL COMMENT '修改时间',
  PRIMARY KEY  (`org_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='机构管理';
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '091a11d3e8e81d7107ce7d4288822504', '2019-01-24 10:21:36', '2019-01-17 10:21:36');
